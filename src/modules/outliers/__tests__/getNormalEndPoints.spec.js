...
describe('getNormalEndPoints', () => {
    it('should return start/end points of the normal', () => {
        ...
        expect(typeof normalEndPoints[0][0]).toBe('number')
        expect(typeof normalEndPoints[0][1]).toBe('number')
        expect(normalEndPoints[1].length).toBe(2)
        expect(typeof normalEndPoints[1][0]).toBe('number')
        expect(typeof normalEndPoints[1][1]).toBe('number')
    })
})
