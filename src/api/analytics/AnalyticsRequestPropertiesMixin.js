    ...
    class extends base {
        ...
        withAggregationType(value) {
            ...
            if (aggregationTypes.has(aggregationType)) {
                ...
                console.warn(
                    `analytics.request.withAggregationType(): "${value}" not listed as possible value`
                )
        ...
        withDisplayProperty(value) {
            ...
            if (displayProperties.has(displayProperty)) {
                ...
                console.warn(
                    `analytics.request.withDisplayProperty(): "${value}" not listed as possible value`
                )
        ...
        withEventStatus(value) {
            ...
            if (eventStatuses.has(eventStatus)) {
                ...
                console.warn(
                    `analytics.request.withEventStatus(): "${value}" not listed as possible value`
                )
        ...
        withProgramStatus(value) {
            ...
            if (programStatuses.has(programStatus)) {
                ...
                console.warn(
                    `analytics.request.withProgramStatus(): "${value}" not listed as possible value`
                )
        ...
        withOuMode(value) {
            ...
            if (ouModes.has(ouMode)) {
                ...
                console.warn(
                    `analytics.request.withOuMode(): "${value}" not listed as possible value`
                )
        ...
        withSortOrder(value) {
            ...
            if (sortOrders.has(sortOrder)) {
                ...
                console.warn(
                    `analytics.request.withSortOrder(): "${value}" not listed as possible value`
                )
        ...
        withOutputType(value) {
            ...
            if (outputTypes.has(type)) {
                ...
                console.warn(
                    `analytics.request.withOutputType(): "${value}" not listed as possible value`
                )
